...
class CharactersFragmentTest{
    ...
    fun shouldShowCharacters_whenViewIsCreated(){
        ...
        onView(withId(R.id.recycler_characters)).check(matches(isDisplayed()))
    }
    ...
    fun shouldLoadMoreCharacters_whenNewPageIsRequested(){
        ...
        onView(withId(R.id.recycler_characters)).perform(RecyclerViewActions.scrollToPosition<CharactersViewHolder>(20))
